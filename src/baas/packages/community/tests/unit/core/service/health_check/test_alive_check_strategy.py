...
from secbaas.core.service.health_check.bot._service import BotHealthCheckerService
...
class TestCheckAliveByBotUnsupported:
    ...
    async def test_sigma_device_returns_unsupported(self) -> None:
        ...
        from secbaas.api.health_check.bot import PaasDeviceInfo
        ...
        # Use enum properly
        from secbaas.api.health_check.bot import DeviceProviderType
    ...
    async def test_arca_openclaw_normal_check(self) -> None:
        ...
        from secbaas.api.health_check.bot import DeviceProviderType, PaasDeviceInfo
