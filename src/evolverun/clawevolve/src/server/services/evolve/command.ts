...
export function parseNodeCommandYamls(
  value: unknown,
  allowed: NodeCommandKey[],
): Partial<Record<NodeCommandKey, string>> {
  if (value == null) return {};
  if (!value || typeof value !== "object" || Array.isArray(value)) {
    throw new Error("nodeCommandYamls 必须是对象");
  }
