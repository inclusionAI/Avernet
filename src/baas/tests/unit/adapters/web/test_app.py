...
# ---------------------------------------------------------------------------
from secbaas.community.adapters.web.app import (
...
class TestRouterRegistration:
    ...
    def test_real_app_router_count_matches_imports(self):
        from secbaas.community.adapters.web.app import app as real_app
...
class TestLoadConfig:
    ...
    def test_loads_config_and_returns_config_object(self, tmp_path):
        ...
        with (
            ...
            from secbaas.community.adapters.web.app import load_config
...
class TestAppModule:
    ...
    def test_lifespan_function_importable_and_callable(self):
        from secbaas.community.adapters.web.app import lifespan
