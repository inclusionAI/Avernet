...
loadtest  local  logs  mcp  models  public  resources  routines  sessions skills
```

Nine of those eighteen — `approvals`, `connection`, `engine`, `identity`,
...
```text
all  authorized  ceiling  check-name  loadtest  local  logs  mcp  public
```
