...
from secbaas.core.service.bot_run._bot_websocket_client import BotWebSocketClient
...
class TestConnect:
    ...
    async def test_connect_handshake_success(self, client):
        ...
        with (
            patch(
                "secbaas.core.service.bot_run._bot_websocket_client.websockets.connect",
                side_effect=mock_connect,
            ),
            patch(
                "secbaas.core.service.bot_run._bot_websocket_client.is_dev",
                return_value=False,
            ),
        ):
