...
pub use http::{
    ...
    PatchOrganizationMemberProfileRequest, PatchOrganizationRequest, RevokeFriendResponse, StatusResponse,
    ...
    ProviderCoordinationConfigDto,
    ProviderCoordinationEventKindDto, ProviderCoordinationEventRequest,
    ProviderCoordinationIntentDto, ProviderBotConnectionModeDto, ProviderCoordinationModeDto,
