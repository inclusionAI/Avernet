...
class TestStalePublishAutoResolution:
    ...
    async def test_auto_resolve_stale_publish_allows_new_publish(self):
        ...
        with patch(
            "secbaas.core.service.publish_manage._publish_service.get_current_env",
    ...
    async def test_execute_stage_processes_batches(self):
        ...
        with patch.object(
            ...
            with patch.object(
                ...
                from secbaas.api.publish_manage import BatchResult
...
class TestProgressModels:
    ...
    def test_publish_progress_response_model(self):
        ...
        from secbaas.api.publish_manage import ProgressTimeline
...
class TestPublishRecordResultLifecycle:
    ...
    async def test_create_batch_success_transitions_to_success(self):
        ...
        from secbaas.api.device_manage import DeviceStatus
        from secbaas.api.publish_manage import PublishRecordResult
...
class TestStateMachineUtils:
    ...
    def test_can_transition_valid_transitions(self):
        ...
        from secbaas.core.service.publish_manage._publish_service import (
            DefaultPublishService,
        )
...
class TestExecuteDestroyBatch:
    ...
    async def test_execute_destroy_batch_success(self):
        ...
        from secbaas.api.device_manage import DeviceStatus
        from secbaas.api.publish_manage import DrainResult, PublishRecordResult
    ...
    async def test_check_stage_advancement_empty_batches_completed_directly(self):
        ...
        with patch(
            ...
            with patch.object(
                ...
                with patch(
                    "secbaas.core.service.publish_manage._publish_service.is_paas_mock_mode",
                    return_value=False,
                ):
