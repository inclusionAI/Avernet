...
class WorkItemServiceProtocol(Protocol):
    ...
    def list_work_item_relations(self, work_item_id: str, operator: str = "100000") -> Dict[str, Any]: ...

    def delete_work_item_relation(self, operator: str, request_body: Dict[str, Any]) -> Dict[str, Any]: ...
