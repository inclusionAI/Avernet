...
class TaskServiceProtocol(Protocol):
    ...
    async def run_template(self, template_id: str, inputs: dict, *, owner_user_id: str, owner_bot_id: str, auto_advance: bool | None = None, owner_account_id: str | None = None) -> TaskOpResult:
