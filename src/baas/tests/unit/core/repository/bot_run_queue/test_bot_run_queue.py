...
import secbaas.community.core.repository.bot_run_queue._orm_model  # noqa: F401
...
from secbaas.community.core.repository.bot_run_queue._orm_model import BotRunQueueModel
