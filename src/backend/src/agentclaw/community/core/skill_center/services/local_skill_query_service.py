"""Desired-state Bot Skill queries for the public API.
...
class LocalSkillQueryService(LocalSkillQueryServiceProtocol):
    """Authorize a Bot scope, then answer for every Skill that Bot has."""
    ...
    def list_bot_skills(
        ...
        *,
        ...
        The repair runs before the page because ``active`` is a *filter*: it
