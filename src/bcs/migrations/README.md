...
The current SQLite migration chain records versions `001` through `009`.
...
existing databases, while versions `008` and `009` add their tables through
the additive bootstrap DDL before recording progress. Future schema changes
should use later numeric versions.
