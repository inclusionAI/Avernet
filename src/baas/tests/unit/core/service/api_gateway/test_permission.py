...
from secbaas.community.api.api_gateway import APIKeyResponse


class TestIsAdmin:
    def test_admin_operator(self):
        from secbaas.community.api.api_gateway import is_admin
        ...
        with patch(
            "secbaas.community.api.api_gateway._permission.get_config", return_value=cfg
        ):
...
class TestParseBotEntityId:
    def test_valid_format(self):
        from secbaas.community.api.api_gateway import parse_bot_entity_id
...
class TestCheckBotPermission:
    def test_operator_matches_entity(self):
        from secbaas.community.api.api_gateway import check_bot_permission
...
class TestCheckPermission:
    def test_key_owner_match(self):
        from secbaas.community.api.api_gateway import check_permission
...
class TestAPIKeyPermissionChecker:
    def test_check_key_owner(self):
        from secbaas.community.api.api_gateway import APIKeyPermissionChecker
