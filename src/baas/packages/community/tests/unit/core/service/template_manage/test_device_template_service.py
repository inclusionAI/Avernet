...
def mock_encrypt() -> MagicMock:
    ...
    with patch(
        "secbaas.core.service.template_manage._device_template_service._ensure_api_key_encrypted"
    ) as m:
        yield m
...
class TestGetDefaultOrExplicitTemplate:
    ...
    def mock_tenant_service(self) -> MagicMock:
        ...
        """
        with patch(
            "secbaas.core.service.tenant_manage.DefaultTenantManageService"
        ) as m:
            yield m
...
class TestEnsureApiKeyEncrypted:
    ...
    def test_encrypts_when_flag_true_and_key_present(self):
        ...
        from secbaas.core.service.template_manage._device_template_service import (
            _ensure_api_key_encrypted,
        )
        ...
        with patch(
            "secbaas.core.service.template_manage._device_template_service.common_sm4_encrypt",
