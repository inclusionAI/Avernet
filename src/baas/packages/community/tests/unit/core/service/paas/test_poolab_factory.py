...
from secbaas.api.device_manage import PoolabCredentials
from secbaas.api.template_manage import (
    PoolabTemplateConfig,
    TemplateStatus,
)
from secbaas.core.service.paas import PaasServiceFactory, PoolabPaasService
...
class TestPoolabCredentialsFromTemplate:
    ...
    @patch("secbaas.core.service.paas._factory.get_current_env")
    @patch("secbaas.core.utils.secret_utils.common_sm4_decrypt")
