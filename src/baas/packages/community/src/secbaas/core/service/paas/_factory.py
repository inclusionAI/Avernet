...
from secbaas.api.template_manage import DeviceTemplateResponse
from secbaas.api.tenant_manage import TenantType
from secbaas.core.service.paas.desktop import get_instance_id
...
if TYPE_CHECKING:
    from secbaas.api.paas import ConnectionManager
    ...
    from secbaas.core.repository.ws_relay_session import WsRelaySessionRepository
    ...
    from secbaas.core.service.template_manage import (
...
class PaasServiceFactory(PaasServiceFactoryProtocol):
    ...
    def _create_poolab_credentials_from_template(
        ...
        Raises:
            ValueError: If template.config is invalid or missing required fields
        """
        from secbaas.api.template_manage import PoolabTemplateConfig
    ...
    def _create_docker_credentials_from_template(
        ...
        """
        from secbaas.api.template_manage import DockerTemplateConfig
    ...
    def _create_teclaw_credentials_from_template(
        ...
        Raises:
            ValueError: If template.config is invalid or missing required fields
        """
        from secbaas.api.template_manage import TeClawTemplateConfig
    ...
    def _create_k8s_credentials_from_template(
        ...
        Raises:
            ValueError: If template.config is invalid or missing required fields
        """
        from secbaas.api.template_manage import K8sTemplateConfig
