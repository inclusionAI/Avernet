...
from secbaas.core.service.device_manage._start_hook_dispatcher import (
...
class TestGetCallbackServer:
    ...
    def test_prod_returns_prod_url(self):
        with patch(
            "secbaas.core.service.device_manage._start_hook_dispatcher.get_current_env",
            return_value="prod",
        ):
            url = _get_callback_server()
            assert url == "https://secbaas-prod.alipay.com"
    ...
    def test_pre_returns_pre_url(self):
        with patch(
            ...
            url = _get_callback_server()
            assert url == "https://secbaas-pre.alipay.com"

    def test_dev_returns_pre_url(self):
        with patch(
            "secbaas.core.service.device_manage._start_hook_dispatcher.get_current_env",
            return_value="dev",
        ):
...
class TestGenerateWrapperScript:
    ...
    def test_renders_shell_script_structure(self):
        ...
        script = _generate_wrapper_script(
            ...
            callback_server="https://secbaas-pre.alipay.com",
            tenant="test-tenant",
        )
        ...
        assert "secbaas-pre.alipay.com" in script
...
class TestDispatchStartHook:
    ...
    def test_launches_background_thread(self):
        ...
        with (
            patch(
                "secbaas.core.service.device_manage._start_hook_dispatcher._execute_wrapper_script",  # noqa: E501
            ),
            patch(
                "secbaas.core.service.device_manage._start_hook_dispatcher._get_callback_server",
                return_value="https://example.com",
            ),
            patch(
                "secbaas.core.service.device_manage._start_hook_dispatcher.threading.Thread",
            ) as mock_thread,
        ):
    ...
    def test_dispatch_failure_calls_report_failure(self):
        ...
        with (
            ...
            patch(
                "secbaas.core.service.device_manage._start_hook_dispatcher._report_failure",
            ),
            patch(
                "secbaas.core.service.device_manage._start_hook_dispatcher.threading.Thread",
            ) as mock_thread,
...
class TestReportFailure:
    ...
    def test_sends_failure_callback(self):
        ...
        with (
            patch(
                "secbaas.core.service.publish_manage.DefaultPublishService.handle_device_callback",  # noqa: E501
                handle_device_callback,
            ),
            patch(
                "secbaas.api.publish_manage.DeviceCallbackRequest",  # noqa: E501
    ...
    def test_report_failure_exception_does_not_raise(self):
        ...
        with (
            patch(
                "secbaas.core.service.publish_manage.DefaultPublishService",  # noqa: E501
    ...
    def test_report_failure_publish_id_none_sends_zero(self):
        ...
        with (
            ...
            patch(
                "secbaas.api.publish_manage.DeviceCallbackRequest",
                return_value=mock_callback,
            ),
        ):
            from secbaas.core.service.device_manage._start_hook_dispatcher import (
            ...
            from secbaas.api.publish_manage import DeviceCallbackRequest
...
class TestExecuteWrapperScriptAsync:
    ...
    def test_debug_file_write_failure_logs_warning(self):
        ...
        with (
            ...
            patch(
                "secbaas.core.service.device_manage._start_hook_dispatcher.logger",
            ) as mock_logger,
        ):
    ...
    def test_execute_wrapper_script_sync_wraps_async(self):
        ...
        with patch(
            "secbaas.core.service.device_manage._start_hook_dispatcher._execute_wrapper_script_async",
        ) as mock_async:
