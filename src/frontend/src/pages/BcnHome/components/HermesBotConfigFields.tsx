  ...
  <div className="grid gap-3 sm:grid-cols-2">
    ...
    >
      ...
      <input
        ...
        aria-invalid={validation.botNameError ? true : undefined}
        aria-describedby={
          validation.botNameError ? `${idPrefix}-bot-name-error` : undefined
        }
    ...
    >
      ...
      <input
        ...
        aria-invalid={validation.profileError ? true : undefined}
        aria-describedby={
          validation.profileError ? `${idPrefix}-profile-error` : undefined
        }
