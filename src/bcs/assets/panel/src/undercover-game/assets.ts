...
export const sprites = {
  ...
  humanFrame:{atlas:'character',x:128,y:0,width:32,height:32},actorShadow:{atlas:'character',x:192,y:0,width:32,height:32},speakingAlt:{atlas:'character',x:224,y:0,width:32,height:32},
