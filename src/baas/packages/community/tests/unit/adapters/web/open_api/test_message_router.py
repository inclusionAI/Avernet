...
from secbaas.adapters.web.routers.open_api.message_router import (
    _normalize_bot_id,
    deliver_message,
...
def _make_message_request(bot_id="bot-1:entity-1", message="hello", metadata=None):
    from secbaas.adapters.web.routers.open_api.model import MessageRequest
...
def _make_stream_message_request(
    ...
    from secbaas.adapters.web.routers.open_api.model import StreamMessageRequest
...
class TestDeliverMessage:
    ...
    async def test_system_app_type_passes_check(self):
        ...
        with patch(
            "secbaas.adapters.web.routers.open_api.message_router.validate_policy",
...
def _make_converter_factory():
    from secbaas.core.service.sse import DefaultStreamConverter
