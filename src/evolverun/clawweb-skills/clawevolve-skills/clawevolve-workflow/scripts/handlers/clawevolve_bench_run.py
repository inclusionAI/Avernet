...
def workflow_config(input_payload: dict[str, Any], args: argparse.Namespace, task_root: Path, invocation_root: Path, clawweb_url: str) -> dict[str, Any]:
    ...
    expected = {
        ...
        "model": str(bench.get("model") or os.environ.get("CLAWEVOLVE_BENCH_MODEL", "openai/gpt-4.1-mini")),
    ...
    return {
        ...
        "bench": {
            ...
            "model": bench.get("model") or os.environ.get("CLAWEVOLVE_BENCH_MODEL", "openai/gpt-4.1-mini"),
