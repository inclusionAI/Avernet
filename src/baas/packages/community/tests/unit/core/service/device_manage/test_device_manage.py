...
def mock_env():
    ...
    with patch(
        "secbaas.core.service.device_manage._device_service.get_current_env",
        return_value="test",
    ):
        yield
...
class TestEncryptHeaderRuleValues:
    ...
    def test_encrypts_matching_rules(self):
        from secbaas.core.service.device_manage import _encrypt_header_rule_values
        ...
        with patch(
            "secbaas.core.service.device_manage._device_service.common_sm4_encrypt",
...
class TestDecryptHeaderRuleValues:
    ...
    def test_decrypts_encrypted_rules(self):
        ...
        with patch(
            "secbaas.core.service.device_manage._device_service.common_sm4_decrypt",
...
class TestDefaultDeviceService:
    ...
    async def test_restart_device_local_no_hook_sets_active(
        ...
        from secbaas.api.template_manage import LocalTemplateConfig
    ...
    async def test_restart_device_arca_with_hook_sets_pending(
        ...
        with patch(
            "secbaas.core.service.device_manage._device_service.dispatch_start_hook"
        ) as mock_dispatch:
            result = await service.restart_device(
                tenant="test-tenant", device_uuid="DEVICE-001"
            )
