...
#: operations without changing the path/query counts. W1 (#1469) adds four
#: own-bot config-manifest operations, all addressing the bot in the path.
...
def test_the_pinned_number_of_operations_take_it():
    ...
    # bringing the combined surface to 218. W1 (#1469) adds four own-bot
    # config-manifest operations, all user-scoped: 222.
