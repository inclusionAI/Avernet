...
from secbaas.api.health_check.bot import BotHealthCheckerConfig
from secbaas.core.service.api_gateway import (
...
from secbaas.core.service.bcn.uplink import (
    BcnUplinkCallback,
    BcnUplinkClient,
    BcnUplinkConfig,
)
from secbaas.core.service.bot_manage import (
    DefaultBotCrudService,
    DefaultBotManagementService,
)
from secbaas.core.service.bot_qpm import DefaultBotQpmManageService
...
from secbaas.core.service.bot_session import DefaultSessionService
from secbaas.core.service.callback import HttpCallback
...
from secbaas.core.service.health_check.paas import PaaSHealthProviderFactory
...
from secbaas.core.service.paas.desktop.instance_router import (
    InstanceRouterConfig,
    ThreadSafeLazyRouter,
)
from secbaas.core.service.paas.desktop.worker_router import WorkerRouter
from secbaas.core.service.publish_manage import (
    DefaultPublishAdminService,
    DefaultPublishService,
)
from secbaas.core.service.scheduler import AppScheduler
from secbaas.core.service.sse import (
    BcnStreamConverter,
    DefaultStreamConverter,  # noqa: F401  触发默认 SSE converter 注册
    SseConverterFactory,
)
from secbaas.core.service.template_manage import DefaultDeviceTemplateService
...
def _real_bot_service_plugin(base_url: str = "", timeout: float = 10.0):
    from secbaas.plugins.bot_service import AiohttpBotServicePlugin

    return AiohttpBotServicePlugin(base_url=base_url, timeout=timeout)


def _stub_bot_service_plugin():
    from secbaas.plugins.bot_service import StubBotServicePlugin

    return StubBotServicePlugin()


def _local_bot_service_plugin():
    from secbaas.plugins.bot_service import LocalBotServicePlugin
