...
def mock_paas_facade():
    ...
    facade.resolve_ws_conn_info.return_value = WsConnectionInfo(
        ws_url="wss://agentclawproxy-prod.service.test/proxypass/ARCA_test-sandbox@10000:20003/api/openclaw/ws",
...
class TestDispatchBotWsConnInfo:
    ...
    async def test_tenant_isolation(
        ...
        with patch(
            "secbaas.community.core.service.bot_runtime.dispatcher._wss_dispatcher.get_current_env",
            return_value="test",
        ):
            await service.dispatch_bot_ws_conn_info(
                bot_uuid="bot-uuid-001",
...
class TestIntegrationScenarios:
    ...
    async def test_full_resolution_flow(
        ...
        assert (
            result.ws_url
            == "wss://agentclawproxy-prod.service.test/proxypass/ARCA_test-sandbox@10000:20003/api/openclaw/ws"
        )
