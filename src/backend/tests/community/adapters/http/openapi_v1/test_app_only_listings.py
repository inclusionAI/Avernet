...
_UNGRANTED_APP_CASES = {
    ("GET", "/openapi/v1/skills/repository"): {
        "request": lambda client: client.get("/openapi/v1/skills/repository"),
        "assert_starved": lambda response: response.status_code == 404,
    },
    ("GET", "/openapi/v1/skills/repository/tree"): {
        "request": lambda client: client.get("/openapi/v1/skills/repository/tree"),
        "assert_starved": lambda response: response.status_code == 404,
    },
    ("GET", "/openapi/v1/skills/{skill_id}"): {
        "request": lambda client: client.get("/openapi/v1/skills/1"),
        "assert_starved": lambda response: response.status_code == 404,
    },
    ("POST", "/openapi/v1/skills/repository/sync"): {
        "request": lambda client: client.post("/openapi/v1/skills/repository/sync"),
        "assert_starved": lambda response: response.status_code == 404,
    },
    ("GET", "/openapi/v1/bots"): {
