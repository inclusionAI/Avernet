...
class TestHealthCheckerBotAlive:
    ...
    @pytest.mark.asyncio
    async def test_alive_minimal_params(
        self, api: APITestHelper, created_bot: dict[str, Any]
    ) -> None:
...
class TestHealthCheckerPaasDevices:
    ...
    @pytest.mark.asyncio
    async def test_paas_devices_with_real_bot(
        self, api: APITestHelper, created_bot: dict[str, Any]
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_paas_devices_with_online_status(
        self, api: APITestHelper, created_bot: dict[str, Any]
    ) -> None:
...
class TestHealthCheckerExtendTTL:
    ...
    @pytest.mark.asyncio
    async def test_extend_ttl_with_real_bot(
        self, api: APITestHelper, created_bot: dict[str, Any]
    ) -> None:
