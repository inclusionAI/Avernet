...
from secbaas.community.core.repository.bot import BotRecord, BotRepository
from secbaas.community.core.repository.device import DeviceRecord, DeviceRepository
