...
(such as ``from secbaas.community.adapters.web.app import lifespan``) do not trigger
...
import ``secbaas.community.bootstrap.ApplicationContainer`` the config has already been
...
from secbaas.community.bootstrap import get_container  # noqa: E402
