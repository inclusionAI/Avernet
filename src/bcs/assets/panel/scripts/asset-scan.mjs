...
const atlases=['src/undercover-game/assets/room-atlas.svg','src/undercover-game/assets/character-atlas.svg','src/undercover-game/assets/ui-atlas.svg','src/undercover-game/assets/speech-frame.svg','src/undercover-game/assets/speech-tail.svg','src/undercover-game/assets/knight-statue.svg'];const atlasBytes=atlases.reduce((sum,file)=>sum+(existsSync(join(root,file))?statSync(join(root,file)).size:0),0);if(atlasBytes>120*1024)findings.push(`production atlases: ${atlasBytes} bytes exceeds 122880-byte budget`);
