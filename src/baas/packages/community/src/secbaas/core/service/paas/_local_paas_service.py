...
if TYPE_CHECKING:
    ...
    from secbaas.core.service.paas.desktop import ConnectionManager, InstanceRouter
    from secbaas.spi.sandbox.desktop import DesktopSandboxPlugin
...
class LocalPaasService(PaasService, LocalPaasServiceProtocol):
    ...
    async def resolve_invoke_http_info(
        ...
        """
        from secbaas.core.utils.proxypass_utils import (
            build_proxypass_url,
        ...
        from secbaas.bootstrap import get_container  # noqa: PLC0415
