...
use bcs_service_api::application::v1::{
    ApplicationError, AuthenticatedCaller, BotService, ListBotCandidates, SearchBotCandidates,
};
...
use crate::v1::openapi::dto::bot::{
    ListBotCandidatesQuery, SearchBotCandidatesQuery,
};

pub fn router() -> Router<ApiState> {
    Router::new()
        .route("/bots/{bot_id}/candidates", get(list_candidates))
        .route("/bots/{bot_id}/candidates/search", get(search_candidates))
}
