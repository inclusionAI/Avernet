...
| 14   | Configuration drives all wiring  | `test_core_rules.py` (bootstrap ban), `test_env_import_regression.py`        | pytestarch + AST | ✅ Active | Env access restricted. Bootstrap import bans enforced.                |
