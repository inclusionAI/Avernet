...
class BotService:
    ...
    def _rebind_coding_bot_to_architect(
        ...
        if previous_architect_bot_id == architect_bot_id:
            logger.info(
                "[bot_service.rebind_architect_bot] no-op, coding bot %s already bound to %s",
        ...
        logger.info(
            "[bot_service.rebind_architect_bot] coding bot %s rebind %s -> %s by %s",
    ...
    def rebind_architect_bot_batch(
        ...
        for coding_bot_id in uniq_ids:
            try:
                ...
                logger.error(
                    "[bot_service.rebind_architect_bot_batch] %s failed: %s",
        ...
        logger.info(
            "[bot_service.rebind_architect_bot_batch] architect=%s total=%d succeeded=%d failed=%d by %s",
