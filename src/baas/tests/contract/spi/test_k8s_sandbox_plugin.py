...
from secbaas.community.plugins.sandbox.k8s.real._client_manager import K8sClientManager
...
class TestRealK8sSandboxPlugin:
    ...
    def test_no_pod_ip_caching(self) -> None:
        ...
        with patch(
            "secbaas.community.plugins.sandbox.k8s.real._real_k8s_sandbox.CoreV1Api",
