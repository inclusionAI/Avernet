"""AICoding extension for request-scoped Arca credentials."""
...
class AicodingArcaRequestApiKeyResolver:
    """Interpret AICoding-owned extra properties at the Arca boundary."""
