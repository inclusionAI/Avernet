...
from secbaas.community.adapters.web.routers.admin.api_gateway_router import (
    AdminBotIdRequest,
...
def admin_ctx() -> OperationContext:
    ...
    return OperationContext(operator="operator-001", env="test")
