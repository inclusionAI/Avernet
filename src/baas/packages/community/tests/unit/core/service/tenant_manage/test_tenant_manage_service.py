...
from secbaas.core.service.tenant_manage import (
...
def make_record(
    ...
    from secbaas.core.repository.tenant import TenantRecord
...
class TestCreateTenant:
    ...
    def test_success(self):
        ...
        with patch(
            "secbaas.core.service.tenant_manage._tenant_manage_service.get_current_env",
            return_value="dev",
        ):
