...
def _setup_session_state(client, session_key=_TEST_SESSION_KEY):
    ...
    from secbaas.core.service.bot_run._async_chat_client import _SessionState
...
def mock_bot_ws():
    ...
    with patch(
        "secbaas.core.service.bot_run._async_chat_client.BotWebSocketClient"
    ) as mock:
        yield mock
...
class TestInit:
    def test_defaults_auto_generates_client_id(self, mock_bot_ws):
        from secbaas.core.service.bot_run._async_chat_client import AsyncChatClient
