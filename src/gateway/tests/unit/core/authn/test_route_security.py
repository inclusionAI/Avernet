...
_HUMAN_ONLY = [
    ...
    ("GET", "/openapi/v1/bots/local/devices/machine-123/files"),
    ("GET", "/openapi/v1/bots/bot-123/local"),
    ("DELETE", "/openapi/v1/bots/bot-123/local"),
    ("GET", "/openapi/v1/bots/bot-123/local/auth-status"),
    ("POST", "/openapi/v1/bots/bot-123/local/restart"),
