...
from secbaas.community.core.service.paas.desktop.instance_router._config import (
    InstanceRouterConfig,
)
from secbaas.community.core.service.paas.desktop.instance_router._lazy_router import (
...
class TestThreadSafeLazyRouterGetRouterSuccessfulInit:
    def test_get_router_initializes_on_first_call(self) -> None:
        ...
        with patch(
            "secbaas.community.core.service.paas.desktop.instance_router.initialize_instance_router",
