"""zdas_worker_profile_content_store (Open-Core Stub - Internal Only)
...
class ZdasWorkerProfileContentStore:
    """Stub - Internal only. Use SQLite/MySQL adapters for open-core."""

    def __init__(self, *args, **kwargs):
        raise ZdasInternalOnlyProviderUnavailable(
            "ZdasWorkerProfileContentStore is internal-only and not available in open-core. "
