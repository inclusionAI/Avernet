...
from agentclaw.community.core.repository.implementations.skill_center.space_skill_publication_recovery import (
    SpaceSkillPublicationRecoveryMixin,
)
...
class SpaceSkillPublicationRepository(
    SpaceSkillPublicationRecoveryMixin, SpaceSkillPublicationRepositoryProtocol
):
    @inject
