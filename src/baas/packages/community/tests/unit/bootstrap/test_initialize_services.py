...
class TestInitializeServicesOrder:
    ...
    async def test_components_started_in_list_order(self):
        ...
        from secbaas.bootstrap._container import initialize_services
        ...
        with patch("secbaas.bootstrap._container._resolve_all_providers"):
...
class TestShutdownServicesOrder:
    ...
    async def test_components_stopped_in_reverse_order(self):
        ...
        from secbaas.bootstrap._container import shutdown_services
