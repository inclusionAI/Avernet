...
if TYPE_CHECKING:
    ...
    from secbaas.core.repository.publish import PublishRecord

from secbaas.api.bot_manage import BotManageService, BotStatus
...
from secbaas.core.service.paas import is_paas_mock_mode
...
class DefaultPublishService(PublishService):
    ...
    async def create_publish(
        ...
        if publish_type == PublishType.UPDATE:
            from secbaas.api.bot_manage import BotConfig as BotConfigModel
    ...
    def _create_device_records_for_publish(
        ...
        """
        from secbaas.api.device_manage import DeviceConfig, DeviceCreate, DeviceStatus
    ...
    async def _execute_update_batch(
        ...
        from secbaas.api.device_manage import DeviceConfig, DeviceStatus
