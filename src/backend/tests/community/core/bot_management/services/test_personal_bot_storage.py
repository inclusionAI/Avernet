...
def test_real_create_prepares_only_personal_and_keeps_original_apply(bot_type):
    ...
    svc._bot_storage_policy.prepare_bot_storage_policy.return_value = {"device_provider": "baas"}
    events = []
    ...
    if bot_type == "personal":
        ...
        svc._bot_storage_policy.prepare_bot_storage_policy.assert_called_once()
