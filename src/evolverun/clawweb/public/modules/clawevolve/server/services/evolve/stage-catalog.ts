...
export function stageRuntimeInputSchema(
  ...
  const base = mode !== "postprocess" ? stage.inputSchema : {
    ...stage.inputSchema,
  ...
  return {
    ...
    properties: {
      ...
      loop: {
        type: "object",
        required: ["round", "previous_result", "user_feedback"],
        additionalProperties: false,
        properties: {
          round: { type: "integer" },
          previous_result: stageExtensionResultSchema(stage, mode),
          user_feedback: {
            type: "object",
            additionalProperties: false,
            properties: {
              ...
              files: {
                ...
                items: {
                  type: "object",
                  required: ["name", "content_type", "size", "sha256", "ref"],
                  additionalProperties: false,
                  properties: {
                    name: { type: "string" },
