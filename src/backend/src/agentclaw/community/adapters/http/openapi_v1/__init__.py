...
The sub-resource groups (identity, mcp, resources, routines, skills) are mounted
**before** the bots group so their literal path segments
(``/openapi/v1/bots/skills`` …) resolve ahead of the agent-CRUD wildcard
