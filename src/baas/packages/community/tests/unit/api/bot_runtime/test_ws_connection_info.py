...
class TestWsConnectionInfo:
    ...
    def test_create_ws_connection_info(self) -> None:
        ...
        info = WsConnectionInfo(
            ws_url="wss://agentclawproxy-prod.service.test/proxypass/ARCA_SANDBOX-123:8080/api/openclaw/ws",
        ...
        assert (
            info.ws_url
            == "wss://agentclawproxy-prod.service.test/proxypass/ARCA_SANDBOX-123:8080/api/openclaw/ws"
        )
