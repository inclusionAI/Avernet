...
loadtest  logs  mcp  models  public  resources  routines  sessions  skills
```

Nine of those sixteen — `approvals`, `connection`, `engine`, `identity`,
...
```text
authorized  ceiling  check-name  loadtest  logs  mcp  public
```
