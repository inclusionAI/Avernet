...
# Arca 代理服务基础 URL
ARCA_PROXY_BASE_URL_DEV = "https://agentclawproxy-dev.alipay.com"
ARCA_PROXY_BASE_URL_PRE = "https://agentclawproxy-pre.alipay.com"
ARCA_PROXY_BASE_URL_PROD = "https://agentclawproxy-prod.alipay.com"
...
def _get_arca_proxy_base_url() -> str:
    ...
    """
    return (
        ARCA_PROXY_BASE_URL_PRE
        if get_current_env() == "pre"
        else ARCA_PROXY_BASE_URL_PROD
    )
...
# New code should import directly from secbaas.core.utils.proxypass_utils.
from secbaas.core.utils.proxypass_utils import (  # noqa: E402, F401
