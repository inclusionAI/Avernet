...
_SEED_TENANT = {
    "id": 1,
    "gmt_create": datetime(2026, 4, 24, 14, 49, 36),
    "gmt_modified": datetime(2026, 4, 28, 16, 45, 10),
    "is_deleted": 0,
    "creator": "creator",
    "modifier": "modifier",
    "name": "team_claw",
...
_SEED_TEMPLATE = {
    "id": 5676,
    "gmt_create": datetime(2026, 4, 28, 14, 30, 19),
    "gmt_modified": datetime(2026, 4, 30, 16, 3, 45),
    ...
    "config": json.dumps(
        {
            "type": "ARCA",
            "base_url": "http://arca-sandbox.dev.net:8080",
            "api_key": "dummp_api_key",
            "app_name": "secbaas",
