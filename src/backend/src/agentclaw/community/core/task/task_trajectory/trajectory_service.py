...
``get_trajectory(task_id, *, do_analysis=False) -> TaskTrajectory`` exposed by
``api/task/task_trajectory_service.py``'s ``TaskTrajectoryServiceProtocol``.
