...
backing the bot/access-key/app registries), so the bot/access-key/app paths
exercise the DB-backed registries end-to-end. The google path swaps the USER chain to a
