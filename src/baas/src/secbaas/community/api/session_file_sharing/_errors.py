...
from secbaas.community.api.bot_runtime import (  # noqa: F401 — re-exported via __init__.py
...
class SessionFileTransferProxyUnavailableError(SessionFileSharingError):
    ...
    error_code = "SESSION_FILE_TRANSFER_PROXY_UNAVAILABLE"
    http_status = 503

    def __init__(self, reason: str = ""):
        self.reason = reason
        super().__init__(f"Session file transfer proxy is not configured: {reason}")
