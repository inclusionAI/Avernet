...
class TestLocalPlatformCreateBot:
    ...
    async def test_create_bot_with_local_deploy_config(self):
        ...
        with patch(
            "secbaas.core.service.bot_manage.resolve_callback_timeout"
...
class TestLocalPlatformStartDevice:
    ...
    async def test_start_device_detects_local_template(self):
        ...
        with patch(
            "secbaas.core.service.paas._facade.PaasServiceFacade"
    ...
    async def test_start_device_raises_error_when_tc_bot_id_missing(self):
        ...
        with patch(
            "secbaas.core.service.template_manage._device_template_service.DefaultDeviceTemplateService.get_default_or_explicit_template"
...
class TestLocalDeployConfigSerialization:
    ...
    async def test_start_device_handles_hook_format_error(self):
        ...
        with patch(
            ...
            with patch(
                "secbaas.core.service.device_manage.dispatch_start_hook"
            ) as mock_dispatch:
