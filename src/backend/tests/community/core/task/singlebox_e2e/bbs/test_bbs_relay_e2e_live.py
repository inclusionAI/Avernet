...
class TestBbsRelayE2ELive(unittest.TestCase):
    ...
    async def _run(self) -> None:
        ...
        def _dash() -> dict:
            return client.get("/openapi/v1/task/dashboard", params={"task_id": TASK_ID}).json()["data"]
        ...
        try:
            ...
            for i, sub in enumerate(SUB_DOMAINS):
                ...
                r = client.post("/openapi/v1/task/bbs/claim", json={"task_id": TASK_ID, "bot_id": jy_id})
                ...
                if i == 0:
                    r2 = client.post("/openapi/v1/task/bbs/claim", json={"task_id": TASK_ID, "bot_id": owner_id})
        ...
        g = client.get("/openapi/v1/task/dashboard", params={"task_id": TASK_ID}).json()["data"]
