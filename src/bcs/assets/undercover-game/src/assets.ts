...
export function spriteUrl(sprite: SpriteCoordinate): string {
  ...
  const cropped = `<svg xmlns="http://www.w3.org/2000/svg" width="${sprite.width}" height="${sprite.height}" viewBox="${sprite.x} ${sprite.y} ${sprite.width} ${sprite.height}" shape-rendering="crispEdges">${atlasBody(atlasSvg[sprite.atlas])}</svg>`;
...
export const sprites = {
  ...
  podium:{atlas:'room',x:0,y:32,width:32,height:32},window:{atlas:'room',x:32,y:32,width:32,height:32},lamp:{atlas:'room',x:64,y:32,width:32,height:32},clock:{atlas:'room',x:96,y:32,width:32,height:32},shelf:{atlas:'room',x:128,y:32,width:32,height:32},plant:{atlas:'room',x:160,y:32,width:32,height:32},frame:{atlas:'room',x:192,y:32,width:32,height:32},shadow:{atlas:'room',x:224,y:32,width:32,height:32},
