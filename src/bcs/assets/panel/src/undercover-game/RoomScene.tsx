...
export interface RoomSceneProps{composition:RoomComposition;actors:ActorViewModel[];host?:ActorViewModel;currentViewerActorId?:string;voting:boolean;showHostOutput:boolean;finished?:boolean;onOpen:(actorId:string,type:'select-actor'|'select-bubble',element:HTMLElement)=>void}
export function RoomScene({composition,actors,host,currentViewerActorId,voting,showHostOutput,finished=false,onOpen}:RoomSceneProps){
