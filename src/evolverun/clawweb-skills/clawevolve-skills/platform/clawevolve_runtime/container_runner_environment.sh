...
ensure_task_runtime_maintenance() {
  local marker_path="${OPENCLAW_WORKSPACE}/clawevolve_results/${TASK_ID}/runner_state/.runtime_maintenance_v1.json"
...
ENVIRONMENT_LOCK="${OPENCLAW_WORKSPACE}/clawevolve_results/.environment.lock"
