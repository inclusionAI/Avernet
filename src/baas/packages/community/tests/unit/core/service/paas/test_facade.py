...
class TestDestroyDevice:
    ...
    async def test_destroy_device_wraps_paas_error(self, facade, mock_service):
        ...
        with patch(
            "secbaas.core.service.template_manage.DefaultDeviceTemplateService.get_by_template_id"
...
class TestLocalPlatform:
    ...
    @patch(
        "secbaas.core.service.template_manage.DefaultDeviceTemplateService.get_default_or_explicit_template"
    )
    @pytest.mark.asyncio
...
class TestGetDeviceInfo:
    ...
    async def test_get_device_info_success(self, facade, mock_service):
        ...
        from secbaas.api.device_manage._device_info import DeviceInfo
