...
class TestPoolabCreationResult:
    ...
    def test_with_all_fields(self):
        ...
        r = PoolabCreationResult(
            ...
            poolab_hostname="antclaw-abc123.inc.service.test",
            poolab_image_id="img-xyz",
            poolab_order_id="order-001",
            poolab_status="READY",
            poolab_openclaw_url="http://antclaw-abc123.inc.service.test:9999",
            poolab_openclaw_token="tok-123456",
            poolab_display_status="OPENED",
            poolab_type="OpenClaw",
            poolab_network_type="PUBLIC",
            poolab_operations_url="http://antclaw-abc123.inc.service.test:9999/?token=123456",
            poolab_remote_url="http://antclaw-abc123.inc.service.test/vnc.html",
            poolab_model_config_type="public",
            poolab_env="TEST",
        )
        assert r.poolab_id == "789"
        assert r.poolab_user_nick == "User Three"
        assert r.poolab_hostname == "antclaw-abc123.inc.service.test"
        assert r.poolab_openclaw_url == "http://antclaw-abc123.inc.service.test:9999"
