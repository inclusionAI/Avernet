"""zdas_worker_profile_binding_store (Open-Core Stub - Internal Only)
...
class ZdasWorkerProfileBindingStore:
    """Stub - Internal only. Use SQLite/MySQL adapters for open-core."""

    def __init__(self, *args, **kwargs):
        raise ZdasInternalOnlyProviderUnavailable(
            "ZdasWorkerProfileBindingStore is internal-only and not available in open-core. "
