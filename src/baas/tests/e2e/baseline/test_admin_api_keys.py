...
All tests in this file hit /api/v1/admin/api-keys/* routes which require
admin-level authentication not available in bare mode. Skipped accordingly.
"""
...
class TestAdminCreate:
    ...
    async def test_admin_create_app_key(self) -> None:
        pytest.skip("Admin endpoints require authentication not available in bare mode")
