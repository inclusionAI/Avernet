...
def _build_arca_detail_config(
    ...
    """
    from secbaas.community.api.device_manage import ArcaDeviceConfig, MountPoint
    ...
    async def start_device(
        ...
        try:
            ...
            if provider_type == "ARCA":
                ...
                from secbaas.community.api.device_manage import LocalDeviceConfig
                ...
                from secbaas.community.api.device_manage import SigmaDeviceConfig
                ...
                from secbaas.community.api.device_manage import PoolabDeviceConfig
                ...
                from secbaas.community.api.device_manage import TeClawDeviceConfig
                ...
                from secbaas.community.api.device_manage import K8sDeviceConfig

                detail_config = K8sDeviceConfig()
                logger.info(f"Built K8sDeviceConfig for device {device_uuid}")
            elif provider_type == "DOCKER":
                from secbaas.community.api.device_manage import DockerDeviceConfig
    ...
    async def update_device(
        ...
        if provider_type == "SIGMA":
            ...
            try:
                ...
                from secbaas.community.api.device_manage import ArcaCreationResult
