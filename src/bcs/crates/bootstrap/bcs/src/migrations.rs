...
const SQLITE_DDL_STATEMENTS: &[&str] = &[
    ...
    "CREATE TABLE IF NOT EXISTS bcs_authz_edge_grants (
        ...
        status TEXT NOT NULL,
        originator_policy_type TEXT NOT NULL,
    ...
    "CREATE INDEX IF NOT EXISTS idx_authz_edge_grants_rules_ref ON bcs_authz_edge_grants(grant_ref_id, grant_kind)",
    ...
    "CREATE INDEX IF NOT EXISTS idx_authz_permission_requests_edge_id ON bcs_authz_permission_requests(edge_id, created_at)",
