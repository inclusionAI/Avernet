...
from secbaas.spi.database import DatabasePluginConfig, DataSourcePlugin
...
class SqliteOrmPlugin(DataSourcePlugin):
    ...
    def create_all(self) -> None:
        ...
        """
        _orm_models = [
            "secbaas.core.repository.ac_bot._orm_model",
            "secbaas.core.repository.ac_bot_publish._orm_model",
            "secbaas.core.repository.api_gateway._orm_model",
            "secbaas.core.repository.bot._orm_model",
            "secbaas.core.repository.bot_device_rel._orm_model",
            "secbaas.core.repository.bot_run._orm_model",
            "secbaas.core.repository.bot_session._orm_model",
            "secbaas.core.repository.device._orm_model",
            "secbaas.core.repository.device_binding._orm_model",
            "secbaas.core.repository.device_template._orm_model",
            "secbaas.core.repository.distributed_lock._orm_model",
            "secbaas.core.repository.local_user_machine._orm_model",
            "secbaas.core.repository.publish._orm_model",
            "secbaas.core.repository.publish_batch._orm_model",
            "secbaas.core.repository.publish_record._orm_model",
            "secbaas.core.repository.system_config._orm_model",
            "secbaas.core.repository.tenant._orm_model",
            "secbaas.core.repository.ws_relay_session._orm_model",
        ]
