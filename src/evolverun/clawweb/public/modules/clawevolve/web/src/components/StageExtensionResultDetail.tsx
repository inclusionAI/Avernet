...
export default function StageExtensionResultDetail({ step, title = '自定义 Stage', stageLabel, modeLabel }: {
  step: EvolveStep
  title?: string
  stageLabel?: string
  modeLabel?: string
  ...
  return <section className="mt-4 rounded-xl border border-gray-200 bg-gray-50/60 p-4">
    <div className="flex flex-wrap items-center gap-2">
      ...
      <span className="rounded bg-violet-50 px-2 py-0.5 text-[10px] font-medium text-violet-700">自定义 Stage</span>
