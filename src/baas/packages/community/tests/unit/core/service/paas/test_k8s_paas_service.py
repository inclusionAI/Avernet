...
from secbaas.api.device_manage._outbound_proxy_rule import K8sOutboundProxyRule
...
class TestGetDeviceInfoWithPods:
    ...
    async def test_get_device_info_with_container_statuses_populates_pods(
        ...
        from secbaas.api.device_manage._device_info import PodInfo
        from secbaas.plugins.sandbox.k8s.stub._stub_k8s_sandbox import StubK8sSandbox
