import type {
  ...
  EvolveDispatchInput,
  EvolveDispatcher,
} from "../../ports/evolve-dispatcher.js";
import type {
  EvolveStepRow,
  EvolveTaskRepositoryPort,
  EvolveTaskRow,
} from "../../ports/evolve-repository.js";

export type StartInitialEvolveStepInput = {
  repo: EvolveTaskRepositoryPort;
  dispatch: EvolveDispatcher;
...
export async function startInitialEvolveStep(
  input: StartInitialEvolveStepInput,
): Promise<{
