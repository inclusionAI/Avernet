...
const ROUTES: &[&str] = &[
    ...
    "src/routes/groups/mod.rs",
    "src/routes/groups/create/mod.rs",
    "src/routes/groups/create/definition.rs",
    "src/routes/groups/create/participants.rs",
    "src/routes/groups/create/response.rs",
    "src/routes/groups/create/spec.rs",
    "src/routes/groups/dto.rs",
    "src/routes/groups/handlers.rs",
    "src/routes/groups/projections.rs",
    "src/routes/groups/translation.rs",
