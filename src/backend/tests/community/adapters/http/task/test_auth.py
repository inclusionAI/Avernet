...
def _signed(method="POST", path="/api/v1/collaboration/tasks/callback/workflow_result", body=b'{"x":1}',
...
def test_hmac_verify_passes():
    ...
    auth.verify(source="bcn", headers=h, raw_body=b'{"x":1}',
                method="POST", path="/api/v1/collaboration/tasks/callback/workflow_result")
