...
class TestPoolabTemplateConfig:
    ...
    def test_with_required_fields(self) -> None:
        ...
        config = PoolabTemplateConfig.model_validate(
            {
                "type": "POOLAB",
                "poolab_endpoint_pre": "https://poolab-pre.service.test",
                "poolab_tenant_id": "tenant-001",
                "poolab_tenant_token": "token-abc123",
            }
        )
        assert config.type == "POOLAB"
        assert config.poolab_endpoint_pre == "https://poolab-pre.service.test"
        ...
        config = PoolabTemplateConfig.model_validate(
            {
                "type": "POOLAB",
                "poolab_endpoint_pre": "https://poolab-pre.service.test",
                "poolab_endpoint_prod": "https://poolab-prod.service.test",
                "poolab_tenant_id": "tenant-001",
                "poolab_tenant_token": "token-abc123",
    ...
    def test_model_dump_round_trip(self) -> None:
        ...
        assert dumped["poolab_endpoint_pre"] == "https://poolab-pre.service.test"
...
class TestPoolabTemplateConfigEnvironmentSelection:
    ...
    def test_get_effective_endpoint_pre(self) -> None:
        ...
        assert config.get_effective_endpoint("pre") == "https://poolab-pre.service.test"
        assert (
            config.get_effective_endpoint("prod") == "https://poolab-prod.service.test"
        )
    ...
    def test_old_field_names_extra_allow(self) -> None:
        ...
        config = PoolabTemplateConfig.model_validate(
            {
                "type": "POOLAB",
                "poolab_endpoint": "https://poolab-pre.service.test",
