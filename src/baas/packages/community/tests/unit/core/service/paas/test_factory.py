...
from secbaas.api.device_manage import LocalCredentials
...
def factory():
    ...
    from secbaas.core.service.paas import PaasSandboxPlugins
...
class TestPaasServiceFactoryEnvironmentAware:
    ...
    @patch("secbaas.core.service.paas._factory.get_current_env")
    @pytest.mark.asyncio
...
class TestPaasServiceFactoryLocal:
    ...
    @patch("secbaas.bootstrap.get_container")
...
class TestPaasServiceFactoryMockMode:
    ...
    def test_create_returns_mock_service_when_mock_enabled(self, factory):
        ...
        from secbaas.core.service.paas import MockPaasService
...
class TestArcaCredentialsFromTemplate:
    ...
    @patch(
        "secbaas.core.utils.secret_utils.common_sm4_decrypt",
