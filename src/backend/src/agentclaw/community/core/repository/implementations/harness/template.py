...
from agentclaw.community.core.repository.protocols.harness import HarnessTemplateRepository as HarnessTemplateRepositoryProtocol
...
class HarnessTemplateRepository(
    HarnessTemplateRepositoryProtocol,
):
