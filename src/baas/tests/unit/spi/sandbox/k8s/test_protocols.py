...
from secbaas.community.spi.sandbox import K8sSandbox, K8sSandboxPlugin
...
class TestPublicApiImports:
    ...
    def test_k8s_sandbox_imports_from_public_api(self):
        from secbaas.community.spi.sandbox import K8sSandbox as KS

        assert KS is K8sSandbox

    def test_k8s_sandbox_plugin_imports_from_public_api(self):
        from secbaas.community.spi.sandbox import K8sSandboxPlugin as KSP
