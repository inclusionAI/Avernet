...
import type { WorkflowNode, PostAction, KnowledgeItem, RetryConfig } from '@avernet/clawweb-shared/web/types'
            ...
            {executorType === 'collaboration' && (
              <CollapsibleSection title="路由配置" defaultOpen={false}>
                <CollaborationRouteEditor
                  executor={node.executor as { type: string; [key: string]: unknown }}
                  onChange={(updated) => updateNode(node.id, { executor: updated as { type: string; [key: string]: unknown } })}
                />
              </CollapsibleSection>
            )}
