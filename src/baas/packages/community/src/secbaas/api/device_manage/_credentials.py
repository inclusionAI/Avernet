...
class ArcaCredentials(PaasCredentials):
    ...
    Attributes:
        base_url: Arca API base URL (e.g., "http://arca-sandbox.alipay.com:8080")
    ...
    base_url: str | None = Field(
        default=None,
        description="Arca API base URL (e.g., 'http://arca-sandbox.alipay.com:8080')",
    )
...
class PoolabCredentials(PaasCredentials):
    ...
    Attributes:
        poolab_endpoint: Poolab API endpoint URL (e.g., "https://poolab-pre.alipay.com")
