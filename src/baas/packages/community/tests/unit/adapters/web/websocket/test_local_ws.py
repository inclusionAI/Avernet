...
from secbaas.adapters.web.websocket.local_management_ws import (
...
class TestLocalManagementRouter:
    ...
    def test_router_has_correct_tags(self) -> None:
        ...
        from secbaas.adapters.web.websocket.local_management_ws import router
...
class TestJWTExtraction:
    ...
    def test_missing_authorization_header_logs_warning(
        ...
        with patch(
            "secbaas.adapters.web.websocket.local_management_ws.logger"
        ) as mock_logger:
...
class TestLocalManagementWebsocketHandler:
    ...
    async def test_callback_with_request_id_creates_task(self) -> None:
        ...
        with patch(
            "secbaas.adapters.web.websocket.local_management_ws.asyncio.create_task",
