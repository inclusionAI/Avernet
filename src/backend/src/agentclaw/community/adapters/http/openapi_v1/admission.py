...
ADMISSION: dict[tuple[str, str], AdmissionMode] = {
    ...
    ("POST", "/openapi/v1/bots/{bot_id}/lifecycle/upgrade"): AdmissionMode.GRANT_CHECKED_ADDRESSED_BOT,
    ("GET", "/openapi/v1/bots/{bot_id}/lifecycle"): AdmissionMode.GRANT_CHECKED_ADDRESSED_BOT,
    ("DELETE", "/openapi/v1/bots/{bot_id}/lifecycle"): AdmissionMode.GRANT_CHECKED_ADDRESSED_BOT,
    ("GET", "/openapi/v1/bots/{bot_id}/lifecycle/approval"): AdmissionMode.GRANT_CHECKED_ADDRESSED_BOT,
    ("PUT", "/openapi/v1/bots/{bot_id}/lifecycle/approval"): AdmissionMode.GRANT_CHECKED_ADDRESSED_BOT,
    ("POST", "/openapi/v1/bots/{bot_id}/lifecycle/advance"): AdmissionMode.GRANT_CHECKED_ADDRESSED_BOT,
    ("POST", "/openapi/v1/bots/{bot_id}/lifecycle/restart"): AdmissionMode.GRANT_CHECKED_ADDRESSED_BOT,
    ("POST", "/openapi/v1/bots/{bot_id}/lifecycle/cancel-staging"): AdmissionMode.GRANT_CHECKED_ADDRESSED_BOT,
    ("POST", "/openapi/v1/bots/{bot_id}/lifecycle/offline"): AdmissionMode.GRANT_CHECKED_ADDRESSED_BOT,
    ("POST", "/openapi/v1/bots/{bot_id}/lifecycle/retry"): AdmissionMode.GRANT_CHECKED_ADDRESSED_BOT,
    ("GET", "/openapi/v1/bots/{bot_id}/edit-lock"): AdmissionMode.GRANT_CHECKED_ADDRESSED_BOT,
