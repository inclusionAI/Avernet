...
async fn test_chat_send_vs_inject_routing() {
    ...
    let group = driver_client.create_group(
        ...
        &driver.bot_id,
        vec![
            ParticipantInfo { bot_uuid: driver.bot_id.clone(), role: Some("driver".to_string()), tags: Vec::new(), message_view_scope: None },
            ParticipantInfo { bot_uuid: consultant.bot_id.clone(), role: Some("consultant".to_string()), tags: Vec::new(), message_view_scope: None },
            ParticipantInfo { bot_uuid: sender.bot_id.clone(), role: Some("consultant".to_string()), tags: Vec::new(), message_view_scope: None },
        ],
...
async fn test_group_context_fields() {
    ...
    let group = client1.create_group(
        ...
        &bot1.bot_id,
        vec![
            ParticipantInfo { bot_uuid: bot1.bot_id.clone(), role: Some("driver".to_string()), tags: Vec::new(), message_view_scope: None },
            ParticipantInfo { bot_uuid: bot2.bot_id.clone(), role: Some("consultant".to_string()), tags: Vec::new(), message_view_scope: None },
            ParticipantInfo { bot_uuid: sender.bot_id.clone(), role: Some("consultant".to_string()), tags: Vec::new(), message_view_scope: None },
        ],
    ).await.expect("Failed to create group");
...
async fn test_bot_responds_with_chat_event() {
    ...
    let group = client.create_group(
        ...
        &bot.bot_id,
        vec![
            ParticipantInfo { bot_uuid: bot.bot_id.clone(), role: Some("driver".to_string()), tags: Vec::new(), message_view_scope: None },
            ParticipantInfo { bot_uuid: sender.bot_id.clone(), role: Some("consultant".to_string()), tags: Vec::new(), message_view_scope: None },
        ],
    ).await.expect("Failed to create group");
