...
class DeviceServiceProtocol(Protocol):
    ...
    def exec_shell_new(self, device_id: str, shell_cmd: str, *, allow_recovery: bool = False) -> Any:
        """Return command exit status/output; recovery also permits FAILED/STOPPED bindings."""
        ...
