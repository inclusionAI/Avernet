          ...
          <header className="flex items-start justify-between gap-4 border-b border-slate-200 bg-white px-7 py-4">
            ...
            <div className="relative flex shrink-0 items-center gap-3">
              {selectedWorkflow.owner_id && (
                <span className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs text-slate-600" title="负责人">
                  负责人 <span className="font-mono text-slate-700">{selectedWorkflow.owner_id}</span>
                </span>
              )}
