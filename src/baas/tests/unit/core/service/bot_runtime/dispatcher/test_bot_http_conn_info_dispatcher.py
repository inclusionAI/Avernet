...
def mock_paas_facade():
    ...
    facade.resolve_invoke_http_info.return_value = HttpConnectionInfo(
        http_url="http://agentclawproxy-prod.service.test/proxypass/ARCA_test-sandbox@10000:20003/api/health",
...
class TestDispatchBotHttpConnInfo:
    ...
    async def test_tenant_isolation(
        ...
        with patch(
            "secbaas.community.core.service.bot_runtime.dispatcher._http_conn_info_dispatcher.get_current_env",
            return_value="test",
        ):
            await service.dispatch_bot_http_conn_info(
                bot_uuid="bot-uuid-001",
