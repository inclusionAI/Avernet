...
from secbaas.plugins.sandbox.k8s.real._client_manager import _DEFAULT_RETRY_MAX_ATTEMPTS
...
class TestRetryK8sCall:
    ...
    def _fast_retry_decorator(func):
        ...
        from secbaas.plugins.sandbox.k8s.real._client_manager import _is_k8s_retryable
