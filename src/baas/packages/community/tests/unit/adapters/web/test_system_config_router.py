...
from secbaas.adapters.web.routers.config_management.system_config_router import router
from secbaas.api.config_manage import (
    SystemConfigListResponse,
    SystemConfigResponse,
)
from secbaas.bootstrap import Provide
...
class TestListConfigs:
    ...
    def test_list_configs_default_pagination(self, client):
        ...
        with patch(
            "secbaas.core.service.config_manage._system_config_service.get_current_env",
            return_value="dev",
        ):
