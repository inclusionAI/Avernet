...
const api = vi.hoisted(() => ({ evolve: { listSkillEvents: vi.fn(), listVersions: vi.fn() }, bots: { list: vi.fn() } }))
...
beforeEach(() => { vi.stubGlobal('React', React); vi.resetAllMocks(); api.bots.list.mockResolvedValue({ bots: [] }) })
