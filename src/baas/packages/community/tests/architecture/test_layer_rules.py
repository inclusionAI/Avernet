...
**KNOWN TECH DEBT** (lazy imports inside function bodies, not caught here):
  - core/repository/*/_factory.py:  ``from secbaas.bootstrap import get_container``
  - plugins/sandbox/utils/arca_utils.py:  ``from secbaas.bootstrap import get_container``
"""
...
def _check_bans(
    ...
    Args:
        ...
        allow: Sub-modules of bans that are allowed (e.g. "secbaas.core.utils").
    """
    allow = allow or []
    violations: list[str] = []
    for banned in bans:
...
_ADAPTER_ALLOW = [
    ...
    # which requires importing ApplicationContainer from secbaas.bootstrap, which transitively
...
def test_api_no_banned_imports(project_architecture):  # noqa: ANN001, ANN201
    ...
    _check_bans("secbaas.api", _API_BANS, project_architecture)
...
def test_spi_no_banned_imports(project_architecture):  # noqa: ANN001, ANN201
    ...
    _check_bans("secbaas.spi", _SPI_BANS, project_architecture)
...
def test_core_no_banned_imports(project_architecture):  # noqa: ANN001, ANN201
    ...
    _check_bans("secbaas.core", _CORE_BANS, project_architecture)
...
_PLUGINS_ALLOW = [
    ...
    "secbaas.core.repository.device_template",
    "secbaas.core.repository.tenant",
...
def test_config_no_banned_imports(project_architecture):  # noqa: ANN001, ANN201
    ...
    _check_bans("secbaas.config", _CONFIG_BANS, project_architecture)
