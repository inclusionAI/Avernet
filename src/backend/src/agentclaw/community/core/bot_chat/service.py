...
from agentclaw.community.core.bot_chat.trace_helpers import (
...
# Keep the historical helper import paths available to existing callers and
# tests while the pure trace transformations live in their own module.
__all__ = [
    "_apply_client_side_filters",
    "_build_observation_tree",
    "_extract_user_input",
