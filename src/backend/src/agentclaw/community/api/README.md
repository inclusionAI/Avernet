...
internal_dependencies:
  ...
  - agentclaw.community.core.engine_runtime.models    # EngineResult — typed in engine_runtime_service.py (real signatures, so the conformance gate can compare them)
