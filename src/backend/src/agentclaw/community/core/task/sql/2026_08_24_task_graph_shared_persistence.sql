...
CREATE TABLE IF NOT EXISTS `task_node_run_info` (
    ...
    `acceptance_result`   text            DEFAULT NULL            COMMENT '验收结果 JSON: {verdict,done_items,gap_items}',
    `actual_goal`         text          DEFAULT NULL            COMMENT '实际执行目标 JSON: {objective,acceptances}',
