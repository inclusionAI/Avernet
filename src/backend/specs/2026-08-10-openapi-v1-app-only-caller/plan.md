...
| The surface admitted here is wide (57 of 71 operations). | Modes are assigned by operation *shape*, not taste; the table is one reviewable artifact; the inventory test proves the surface matches it. |
