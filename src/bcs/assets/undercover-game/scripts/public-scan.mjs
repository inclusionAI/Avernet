...
const atlases=['src/assets/room-atlas.svg','src/assets/character-atlas.svg','src/assets/ui-atlas.svg'];const atlasBytes=atlases.reduce((sum,file)=>sum+(existsSync(join(root,file))?statSync(join(root,file)).size:0),0);if(atlasBytes>120*1024)findings.push(`production atlases: ${atlasBytes} bytes exceeds 122880-byte budget`);
